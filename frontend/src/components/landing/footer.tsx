    ...
    <footer className="container-md mx-auto mt-32 flex flex-col items-center justify-center">
      ...
      <div className="text-muted-foreground container flex h-20 flex-col items-center justify-center text-sm">
        <p className="text-center font-serif text-lg md:text-xl">
          &quot;Three words for every property. One phone number for every lead. One social feed for the whole industry. That’s how we replaced the old real estate world. That’s CREmarket.io. &quot; - Hahz Terry
        </p>
      </div>
